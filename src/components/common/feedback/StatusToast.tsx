    ...
    <AnimatePresence>
      {toast ? (
        <motion.div
          ...
          className="absolute top-[22px] right-6 left-6 z-50 flex min-h-[48px] items-center justify-center gap-2 rounded-[15px] bg-[#15151a] px-4 text-center text-[12px] font-bold text-white shadow-[0_14px_36px_rgba(21,21,26,0.24)]"
        >
